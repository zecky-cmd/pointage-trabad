...
export default function Sidebar({ isOpen, onClose, role }: SidebarProps) {
  ...
  return (
    <>
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 bg-[#1e1e2d] text-white transition-transform duration-300 ease-in-out md:translate-x-0 shadow-2xl flex flex-col",
      ...
      >
        ...
        <div className="flex-1 px-3 py-4 space-y-1 overflow-y-auto custom-scrollbar">
          <div className="text-xs font-bold text-gray-500 uppercase mb-3 px-3 tracking-wider">
            Menu Principal
          </div>
        ...
        <div className="p-3 border-t border-white/10 shrink-0">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 w-full rounded-xl text-gray-400 hover:bg-red-500/10 hover:text-red-500 transition-all duration-200 group"
          >
